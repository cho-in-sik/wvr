      ...
      <div className="flex flex-col justify-center items-center mb-32">
        <div className="font-sans flex flex-col justify-center items-center mt-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center sm:items-start">
            ...
            <div className="order-1 flex justify-center items-center gap-2 rounded-full px-8 py-6 w-full max-w-xs text-[#4590C4] shadow-lg text-2xl font-medium sm:-mr-8 mt-5">
              스마트 인프라 & AI 솔루션
            </div>
            {/* 중앙 이미지 - 모바일: order-3, 데스크탑: order-2 */}
            <div className="order-3 sm:order-2 w-full sm:max-w-xl p-10 border-4 border-[#E2F0D9] rounded-full relative">
            ...
            <div className="order-2 flex justify-center items-center gap-2 rounded-full px-8 py-6 w-full max-w-xs text-[#62B9A3] shadow-lg text-2xl font-medium sm:-ml-8 mt-5">
              데이터 기반 예측
            </div>
          </div>
          {/* 하단 카드 영역 */}
          <div className="flex flex-col sm:flex-row justify-between w-full items-center mt-10 sm:-mt-32">
            <div className="flex justify-center items-center gap-2 rounded-full px-8 py-6 w-full max-w-xs text-[#62B9A3] shadow-lg text-2xl font-medium mt-5 sm:ml-9 mx-auto">
              스마트 자산관리
            </div>
            <div className="flex justify-center items-center gap-2 rounded-full px-8 py-6 w-full max-w-xs text-[#4590C4] shadow-lg text-2xl font-medium mt-5 sm:mr-9 mx-auto">
              지속 가능한 환경 관리
            </div>
          </div>
        </div>
