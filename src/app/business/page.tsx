...
export default function Page() {
  ...
  return (
    <div>
      ...
      {/* 이미지 박스 영역 */}
      <div className="text-white font-sans flex justify-center items-center gap-20 flex-wrap px-4 md:px-20 mb-32">
        {/* 상수도 관리 */}
        <div className="relative flex flex-col justify-center items-center w-full sm:w-1/2 lg:w-[35%] h-80 sm:h-80 md:h-96 lg:h-[32rem]">
          {/* 배경 이미지 */}
          <div
          ...
          <div className="relative z-10 flex flex-col items-center justify-center w-full h-full">
            ...
            <h4 className="text-xl sm:text-3xl lg:text-5xl font-black">
              상수도 관리
            </h4>
        ...
        <div className="relative flex flex-col justify-center items-center w-full sm:w-1/2 lg:w-[35%] h-80 sm:h-80 md:h-96 lg:h-[32rem]">
          {/* 배경 이미지 */}
          <div
            className="absolute inset-0 bg-cover bg-center bg-no-repeat bg-[url('/images/business/business3.jpeg')]"
            style={{ filter: 'brightness(0.9)' }}
          ></div>
          {/* 어두운 오버레이 */}
          <div className="absolute inset-0 bg-black opacity-10"></div>
      ...
      <div className="w-full flex flex-col justify-center items-center gap-40 mb-20">
        <div id="section-1">
          ...
          <div className="text-3xl bg-[#F3F3F3] py-4 px-10 mb-5">
          ...
          <div className="flex justify-center items-center gap-20 mb-10">
            <div className="flex flex-col justify-center items-start gap-5 text-xl">
              <div>
              ...
              <div>
                ...
                <br /> 상수관로의 노후화 정도를 예측해 선제적인 교체 및 보수를
                지원하고
                <br /> 물 손실을 최소화하고, 관리 비용을 절감합니다.
              </div>
            </div>
            <Image src={sansu} alt="sangsu" width={500} />
          </div>
          <div className="text-2xl flex flex-col gap-4 mb-10">
            <h3 className="text-3xl mb-5">핵심가치</h3>
            <h4>
          ...
          <div className="mb-10">
            <h3 className="text-3xl mb-8">주요 기술 및 시스템</h3>
            <div className="flex justify-between items-center gap-5">
              <div className="flex flex-col justify-end items-center border w-1/3">
                <div className="bg-[#C8E3B7] w-full text-center py-2 rounded-t-lg font-bold text-xl">
                  데이터 베이스 구축
                </div>
                <div className="py-5 text-xl text-slate-800">
                  유량 및 압력 데이터 통합 관리
                </div>
              </div>
              <div className="flex flex-col justify-end items-center border w-1/3">
          ...
          <div>
            <h3 className="text-3xl mb-8">기대효과</h3>
            <div className="w-full flex flex-col justify-center items-center">
              <div className="w-full flex flex-col md:flex-row justify-around items-center -mb-10 gap-28">
                <div className="flex justify-center items-center w-full md:w-1/2 h-36 bg-slate-100 rounded-md relative mb-4 md:mb-0">
                  <div className="w-2/3 flex flex-col justify-start items-start px-3 gap-2 ">
                  ...
                  <div className="w-1/3 h-full flex text-center justify-center items-center bg-[#C1EAFF] text-xl font-semibold">
                    물 인프라 관리
                    <br />
                    효율성 향상
                  </div>
              ...
              <div className="relative z-10">
                <Image src={effect} alt="effect" width={200} />
                <div className="absolute top-1/3 left-[36%] text-3xl bg-gradient-to-r to-green-500 from-blue-600 bg-clip-text text-transparent">
                  기대
                  <br />
                  효과
                </div>
              ...
              {/* 하단 카드 행 */}
              <div className="w-full flex flex-col md:flex-row -mt-10 justify-around items-center  gap-28">
                <div className="flex justify-center items-center w-full md:w-1/2 h-36 bg-slate-100 rounded-md relative mb-4 md:mb-0">
                  <div className="w-2/3 flex flex-col justify-start items-start px-3 gap-2 ">
                    <div>
                ...
                <div className="flex justify-center items-center w-full md:w-1/2 h-36 bg-slate-100 rounded-md relative mb-4 md:mb-0">
                  <div className="w-1/3 h-full text-center justify-center items-center bg-[#C1EAFF] text-xl font-semibold flex flex-col">
                    <span>해외진출 확장성</span>
          ...
          <div className="flex justify-center items-center gap-20 mb-10">
            <div className="flex flex-col justify-center items-start gap-5 text-xl">
              ...
              <div>
                ...
                절감하여
                <br /> 하수처리 비용을 절감하고 탄소 저감을 실현합니다.
              </div>
            </div>
            <Image src={hasu} alt="hasu" width={500} />
          </div>
          <div className="text-2xl flex flex-col gap-4 mb-10">
            <h3 className="text-3xl mb-5">핵심가치</h3>
            <h4>
        ...
        <div id="section-4">
          ...
          <div className="text-3xl text-center bg-[#F3F3F3] py-4 px-10 mb-5">
