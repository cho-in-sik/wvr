export default function Privacy() {
  return (
    <div className="flex flex-col gap-5 font-sans text-sm md:text-base font-medium px-4 md:px-8">
      <div className="leading-relaxed">
        &quot;(주)더블유브이알&quot;은(는) (이하 &quot;회사&quot;는) 고객님의
        ...
        개별공지)을 통하여 공지할 것입니다.
        <br />
        ο 개인정보취급방침 공고일 : 2023년 11월 16일
        <br />ο 본 방침은 : [ 2023년 11월 16일 ] 부터 시행됩니다.
      </div>
      <div className="leading-relaxed">
        개인정보 수집에 대한 동의
        <br />
        회사는 귀하께서 회사의 개인정보보호방침 또는 이용약관의 내용에 대해
      ...
      <div className="leading-relaxed">
        아동의 개인정보보호
        <br />
        ο 회사는 만14세 미만 아동의 개인정보를 수집하는 경우 법정대리인의 동의를
        받습니다.
        <br />ο 만14세 미만 아동의 법정대리인은 아동의 개인정보의 열람, 정정,
        동의철회를 요청할 수 있으며, 이러한 요청이 있을 경우 회사는 지체없이
        필요한 조치를 취합니다.
      </div>
      <div className="leading-relaxed">
        수집하는 개인정보의 항목
        ...
        수집하고 있습니다.
        <br />
        ο 수집항목 : 이름 , 생년월일 , 성별 , 로그인ID , 비밀번호 , 자택
        전화번호 , 자택 주소 , 휴대전화번호 , 이메일 , 직업 , 결혼여부 ,
        주민등록번호 , 서비스 이용기록 , 접속 로그 , 쿠키 , 접속 IP 정보 ,
        결제기록
      ...
      <div className="leading-relaxed">
        ...
        <br />
        ο 서비스 제공에 관한 계약 이행 및 서비스 제공에 따른 요금정산, 콘텐츠
        제공, 구매 및 요금 결제, 물품배송 또는 청구지 등 발송
        <br />
        ο 회원 관리 : 회원제 서비스 이용에 따른 본인확인, 개인 식별, 불량회원의
        부정 이용 방지와 비인가 사용 방지, 가입 의사 확인, 연령확인, 만14세 미만
        아동 개인정보 수집 시 법정 대리인 동의여부 확인, 불만처리 등 민원처리,
        고지사항 전달
        <br />ο 마케팅 및 광고에 활용 : 이벤트 등 광고성 정보 전달, 접속 빈도
        파악 또는 회원의 서비스 이용에 대한 통계 (단, 이용자의 기본적 인권
        침해의 우려가 있는 민감한 개인정보는 수집하지 않습니다.)
      </div>
      <div className="leading-relaxed">
        개인정보의 보유 및 이용기간
        <br />
        ο 귀하의 개인정보는 다음과 같이 개인정보의 수집목적 또는 제공받은 목적이
        달성되면 파기됩니다.
        <br />
        ...
        <br />
        - 배송정보의 경우, 물품 또는 서비스가 인도되거나 제공된 때 (단, 상법 등
        법령의 규정에 의하여 보존할 필요성이 있는 경우에는 예외로 합니다.)
        <br />ο 위 보유기간에도 불구하고 계속 보유하여야 할 필요가 있을 경우에는
        귀하의 동의를 받겠습니다.
      </div>
      <div className="leading-relaxed">
        개인정보의 파기 절차 및 방법
        ...
        파기절차 및 방법은 다음과 같습니다.
        <br />
        ο 파기절차 : 회원님이 회원가입 등을 위해 입력하신 정보는 목적이 달성된
        ...
        <br />ο 파기방법 : 전자적 파일형태로 저장된 개인정보는 기록을 재생할 수
      ...
      <div className="leading-relaxed">
        수집한 개인정보의 위탁
        <br />
        회사는 서비스 향상을 위해서 귀하의 개인정보를 외부에 위탁하여 처리할 수
        있습니다.
        <br />
        ο 개인정보의 처리를 위탁하는 경우에는 미리 그 사실을 귀하에게
        고지하겠습니다.
        <br />
        ο 개인정보의 처리를 위탁하는 경우에는 위탁계약 등을 통하여
      ...
      <div className="leading-relaxed">
        ...
        강구하고 있습니다.
        <br />
        ο 귀하의 개인정보는 비밀번호에 의해 보호되며, 파일 및 전송 데이터를
        암호화하거나 파일 잠금기능(Lock)을 사용하여 중요한 데이터는 별도의
        보안기능을 통해 보호되고 있습니다.
        <br />
        ο 회사는 백신프로그램을 이용하여 컴퓨터바이러스에 의한 피해를 방지하기
        위한 조치를 취하고 있습니다.
        <br />
        ...
        있습니다.
        <br />
        ο 회사는 암호알고리즘을 이용하여 네트워크 상의 개인정보를 안전하게
        전송할 수 있는 보안장치(SSL 또는 SET)를 채택하고 있습니다.
        <br />ο 해킹 등에 의해 귀하의 개인정보가 유출되는 것을 방지하기 위해,
      ...
      <div className="leading-relaxed">
        ...
        운용합니다.
        <br />
        쿠키란 oo의 웹사이트를 운영하는데 이용되는 서버가 귀하의 브라우저에
        ...
        저장을 거부할 수도 있습니다.
        <br />
        ▶ 쿠키 설정 거부 방법 예: 쿠키 설정을 거부하는 방법으로는 회원님이
